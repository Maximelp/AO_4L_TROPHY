if($(".main-container .dsq .slides li video")){
		...
		// Gallery
			...
			// Slideshow - Vertical & Horizontal Nav
				...
				function openFbShare(){
					...
					$('.partagedon').fadeIn(400);
				}
				$('.closewindow').click(function(){
					$('.cache_window').fadeOut(400);
					$('.partagedon').fadeOut(400);
				});
				...
				function popup() {
			      Pub=window.open("https://www.facebook.com/sharer/sharer.php?u=http://www.4ltrophy.com/","pub","toolbar=no,location=yes,directories=no,menubar=no,scrollbars=yes,status=yes,resizable=1,width=450, height=100");
			    }
				...
				function playvideo1(){
					var video = document.getElementById("pub1");
					video.play();
				...
				function playvideo2(){
					var video = document.getElementById("pub2");
					video.play();
					//video.addEventListener('ended',myHandler,false);
				    //function myHandler(e) {
				    //    restartslider();
				...
				function restartslider(){
					$(".full-screen.flexslider").flexslider('play');
					setTimeout(showcontrol,5000);
				}

				function refreshvideo(){
					var video = document.getElementById("pub1");
					var video2 = document.getElementById("pub2");
					video.pause();
					video2.pause();
					video.currentTime = 0;
